...
async def _gerar_curiosidade() -> dict | None:
    ...
    prompt = (
        ...
        "- NÃO anuncie o tema. Comece direto com o fato mais surpreendente — sem introdução\n"
        "- Texto entre 110 e 125 palavras (o CTA será adicionado depois, totalizando ~60s)\n"
        "- CONTEXTO: o ouvinte não conhece o assunto — dê o contexto mínimo para ele entender o fato.\n"
        "- COERÊNCIA: escolha UM aspecto inusitado e desenvolva-o com começo, meio e fim.\n"
        "  Não pule de subtema em subtema — uma curiosidade bem explicada vale mais que três pela metade.\n"
        "- Inclua o essencial: o fato, por que surpreende e 1-2 detalhes que reforcem o impacto\n"
...
if __name__ == "__main__":
    ...
    if YOUTUBE_UPLOAD:
        ...
        if not ok:
            ...
            try:
                from telegram_notifier import notify
                notify(f"⚠️ <b>Curiosidades:</b> token do YouTube expirado/inválido — pipeline abortado.\n{msg}")
            except Exception:
                pass
            sys.exit(1)
